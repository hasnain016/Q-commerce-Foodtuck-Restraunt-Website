...
const chefs = [
  { name: 'D.Estwood', role: 'Chief Chef', image: '/cheif.jpg' },
  { name: 'D.Scoriesh', role: 'Assistant Chef', image: '/cheif1.jpg' },
  { name: 'M. William', role: 'Advertising Chef', image: '/cheif2.jpg' },
  { name: 'W.Readfroad', role: 'Chef', image: '/cheif3.jpg' },
]
